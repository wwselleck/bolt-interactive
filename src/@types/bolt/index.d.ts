declare module "bolt" {
  ...
  export function workspaceRun(options: WorkspaceRunOptions);
  ...
  export function workspacesRun(options: WorkspacesRunOptions);
  ...
  export function projectRun(options: ProjectRunOptions);
}
